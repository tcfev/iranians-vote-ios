...
@class IdentityClaimDetailsBody;
...
@class IdentityIsFinalizedRequest;
...
@class IdentityProveIdentityParams;
@class IdentityQRRegistrationData;
@class IdentityQRRegistrationResponse;
@class IdentityQuery;
@class IdentityQueryWithFieldName;
@class IdentityRegisterProofParams;
...
@class IdentityStatesMerkleData;
...
- (NSData* _Nullable)getGISTProof:(NSString* _Nullable)userId blockNumber:(NSString* _Nullable)blockNumber error:(NSError* _Nullable* _Nullable)error;
...
@interface IdentityClaimDetailsBody : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;
...
- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
- (NSString* _Nonnull)did;
- (NSString* _Nonnull)didToId:(NSString* _Nullable)did error:(NSError* _Nullable* _Nullable)error;
- (NSString* _Nonnull)generateJWZ:(NSData* _Nullable)payload error:(NSError* _Nullable* _Nullable)error;
- (NSData* _Nullable)getCommitmentIndex:(NSString* _Nullable)secret nullifier:(NSString* _Nullable)nullifier error:(NSError* _Nullable* _Nullable)error;
- (NSString* _Nonnull)getID:(NSError* _Nullable* _Nullable)error;
// skipped method Identity.GetIssuerState with unsupported parameter or return types

- (NSData* _Nullable)isFinalized:(NSData* _Nullable)isFinalizedRequestJSON error:(NSError* _Nullable* _Nullable)error;
// skipped method Identity.PrepareAuth2Inputs with unsupported parameter or return types

- (IdentityRegistrationData* _Nullable)register:(NSData* _Nullable)offerData rarimoCoreURL:(NSString* _Nullable)rarimoCoreURL issuerDid:(NSString* _Nullable)issuerDid votingAddress:(NSString* _Nullable)votingAddress schemaJsonLd:(NSData* _Nullable)schemaJsonLd issuingAuthorityCode:(NSString* _Nullable)issuingAuthorityCode stateInfoJSON:(NSData* _Nullable)stateInfoJSON error:(NSError* _Nullable* _Nullable)error;
@end

@interface IdentityIsFinalizedRequest : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;

- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
@property (nonatomic) NSString* _Nonnull rarimoCoreURL;
@property (nonatomic) NSString* _Nonnull issuerDid;
@property (nonatomic) NSData* _Nullable stateInfoJSON;
@property (nonatomic) int64_t timestamp;
@end
...
@interface IdentityProveIdentityParams : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;

- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
@property (nonatomic) NSString* _Nonnull issuingAuthority;
@property (nonatomic) NSString* _Nonnull documentNullifier;
@property (nonatomic) NSString* _Nonnull commitment;
@end

@interface IdentityQRRegistrationData : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;

- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field QRRegistrationData.ProveIdentityParams with unsupported type: github.com/rarimovoting/identity.ProveIdentityParams

// skipped field QRRegistrationData.RegisterProofParams with unsupported type: github.com/rarimovoting/identity.RegisterProofParams

@end

@interface IdentityQRRegistrationResponse : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;
...
- (nonnull instancetype)init;
@property (nonatomic) NSString* _Nonnull type;
// skipped field QRRegistrationResponse.Data with unsupported type: github.com/rarimovoting/identity.QRRegistrationData
...
@interface IdentityRegisterProofParams : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;

- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field RegisterProofParams.A with unsupported type: []string

// skipped field RegisterProofParams.B with unsupported type: [][]string

// skipped field RegisterProofParams.C with unsupported type: []string

// skipped field RegisterProofParams.Inputs with unsupported type: []string

// skipped field RegisterProofParams.StatesMerkleData with unsupported type: github.com/rarimovoting/identity.StatesMerkleData

@end

@interface IdentityRegistrationData : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;
...
@property (nonatomic) NSString* _Nonnull nullifier;
@property (nonatomic) NSString* _Nonnull calldata;
@property (nonatomic) NSString* _Nonnull documentNullifier;
@end
...
@interface IdentityStatesMerkleData : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) _Nonnull id _ref;

- (nonnull instancetype)initWithRef:(_Nonnull id)ref;
- (nonnull instancetype)init;
// skipped field StatesMerkleData.MerkleProof with unsupported type: []string

@property (nonatomic) NSString* _Nonnull createdAtTimestamp;
@property (nonatomic) NSString* _Nonnull issuerState;
@property (nonatomic) NSString* _Nonnull issuerID;
@end
...
// skipped variable LightweightStateMetaData with unsupported type: *github.com/ethereum/go-ethereum/accounts/abi/bind.MetaData
...
// skipped variable VotingMetaData with unsupported type: *github.com/ethereum/go-ethereum/accounts/abi/bind.MetaData

@end

FOUNDATION_EXPORT NSString* _Nonnull IdentityBigIntToString(NSString* _Nullable raw, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT long IdentityBtoi(BOOL b);

FOUNDATION_EXPORT NSString* _Nonnull IdentityGenerateVotingCalldata(NSData* _Nullable proofJson, NSData* _Nullable pubSignalsJson, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT IdentityIdentity* _Nullable IdentityLoad(NSString* _Nullable secretKeyHex, id<IdentityStateProvider> _Nullable stateProvider, NSError* _Nullable* _Nullable error);

FOUNDATION_EXPORT NSString* _Nonnull IdentityNewBJJSecretKey(void);
...
// skipped function NewLightweightStateCoder with unsupported parameter or return types


// skipped function NewRegistrationCoder with unsupported parameter or return types


// skipped function NewVotingCoder with unsupported parameter or return types
